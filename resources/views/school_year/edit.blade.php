    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    {!! Form::open(['url' =>['school_year_update',$school_year_edit->id],'class' => 'form_advanced_validation','method' => 'post','files' => true]) !!}
                    <div class="form-group form-float">
                        <div class="form-line">
                            <label class="form-label">School Year</label>
                            <input type="text" class="form-control" name="title" value="{{$school_year_edit->title}}" maxlength="30" minlength="4" required>
                        </div>
