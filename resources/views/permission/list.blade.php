            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        <a href="{{url('permission/create')}}" class="dropdown-toggle btn btn-info">New Add</a>
                    </ul>
                </div>
                <div class="body">
                            ...
                            @foreach($permissionList as $permission)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{ Form::open(array('url' => 'roles/' . $permission->id, 'class' => 'pull-left')) }}
                                        {{ Form::hidden('_method', 'DELETE') }}
                                        {{ Form::submit('Delete', array('class' => 'btn btn-danger')) }}
                                        {{ Form::close() }}
                                        <a class="btn btn-primary waves-effect" href="{{ URL::to('permission/' . $permission->id . '/edit') }}" style="margin-left: 5px"> <i class="material-icons">edit</i> Edit</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
