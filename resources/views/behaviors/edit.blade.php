...
@section('content')
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>School Behavior Permission Edit Form</h2>
                ...
                <div class="body">
                    {{ Form::model($behavior, array('route' => array('behaviors.update', $behavior->id), 'method' => 'PUT')) }}
                    <div class="form-group form-float">
                        <div class="form-line">
                            <label class="form-label">Title</label>
                            <input type="text" class="form-control" name="title" value="{{$behavior->title}}" maxlength="30" minlength="4" required>
                        </div>
